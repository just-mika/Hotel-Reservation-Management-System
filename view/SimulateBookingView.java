...
public class SimulateBookingView {
    ...
    public SimulateBookingView(){
        ...
        titleImageIcon = new ImageIcon(getClass().getResource("images/HRS Title_SimulateBooking.png"));
        titleLbl = new JLabel("");
        titleLbl.setIcon(titleImageIcon);
        titleLbl.setBounds(230, 50, 620, 30);

        titleImageIcon_1 = new ImageIcon(getClass().getResource("images/HRS Title_SimulateBooking_ChooseHotel.png"));
        titleLbl_1 = new JLabel("");
        titleLbl_1.setIcon(titleImageIcon_1);
        titleLbl_1.setBounds(230, 50, 650, 30);

        titleImageIcon_2 = new ImageIcon(getClass().getResource("images/HRS Title_SimulateBooking_ChooseReservation.png"));
        ...
        this.roomTypeLbl.setPreferredSize(new Dimension(620, 15));
        this.standardRoom = new JRadioButton("Standard");
