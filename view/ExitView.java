...
public class ExitView {
    ...
    public ExitView(){
        ...
        titleImageIcon = new ImageIcon(getClass().getResource("images/HRS Title_ExitProgram.png"));
        titleLbl = new JLabel("");
        titleLbl.setIcon(titleImageIcon);
        titleLbl.setBounds(230, 50, 620, 30);

        titleImageIcon_1 = new ImageIcon(getClass().getResource("images/ExitView_Credits.png"));
